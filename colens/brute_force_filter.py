...
def brute_force_filter_template(
    ...
    for (
        ...
        for time_slide_index in range(num_slides):
            ...
            output_data.H1_lensed.snr_real.append(float(snr_H1_at_trigger_lensed.real))
            output_data.H1_lensed.snr_imag.append(float(snr_H1_at_trigger_lensed.imag))
            output_data.L1_lensed.snr_real.append(float(snr_L1_at_trigger_lensed.real))
            output_data.L1_lensed.snr_imag.append(float(snr_L1_at_trigger_lensed.imag))
