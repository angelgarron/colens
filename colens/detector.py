...
def calculate_antenna_pattern(detectors, sky_grid: SkyGrid, trigger_time: int | float):
    ...
    Args:
        ...
        trigger_time (int | float): Time at which the antenna patterns should be computed.
    """
    antenna_pattern = {}
